...
public class HelloServiceLocator extends org.apache.axis.client.Service implements Controller.HelloService {
    ...
    private java.lang.String HelloPort_address = "http://localhost:8080/Controller";
    ...
    public Controller.HelloWorld getHelloPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Controller.HelloPortBindingStub _stub = new Controller.HelloPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Controller.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                Controller.HelloPortBindingStub _stub = new Controller.HelloPortBindingStub(new java.net.URL(HelloPort_address), this);
                _stub.setPortName(getHelloPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Controller.br.well.com/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Controller.br.well.com/", "HelloPort"));
        }
